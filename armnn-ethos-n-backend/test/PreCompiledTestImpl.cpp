...
template <typename ConvolutionDescriptor>
LayerTestResult<uint8_t, 4> PreCompiledFusedActivationTestImpl(armnn::IWorkloadFactory& workloadFactory,
                                                               const armnn::IBackendInternal::IMemoryManagerSharedPtr&,
                                                               unsigned int inputSize,
                                                               unsigned int outputSize,
                                                               unsigned int channels,
...
LayerTestResult<uint8_t, 2> PreCompiledFullyConnectedTestImpl(armnn::IWorkloadFactory& workloadFactory,
                                                              const armnn::IBackendInternal::IMemoryManagerSharedPtr&,
...
LayerTestResult<uint8_t, 4> PreCompiledDepthToSpaceTestImpl(armnn::IWorkloadFactory& workloadFactory,
                                                            const armnn::IBackendInternal::IMemoryManagerSharedPtr&)
{
    // Construct network
    Network net;
...
LayerTestResult<uint8_t, 4> PreCompiledMultiInputTestImpl(armnn::IWorkloadFactory& workloadFactory,
                                                          const armnn::IBackendInternal::IMemoryManagerSharedPtr&)
{
    // Set up tensor infos
...
LayerTestResult<uint8_t, 1> PreCompiled1dTensorTestImpl(armnn::IWorkloadFactory& workloadFactory,
                                                        const armnn::IBackendInternal::IMemoryManagerSharedPtr&)
{
    // Set up tensor infos
...
LayerTestResult<uint8_t, 2> PreCompiled2dTensorTestImpl(armnn::IWorkloadFactory& workloadFactory,
                                                        const armnn::IBackendInternal::IMemoryManagerSharedPtr&)
{
    // Set up tensor infos
    TensorInfo inputInfo({ 1, 2, 2, 60 }, DataType::QAsymmU8, 1.0f, 0);
...
LayerTestResult<uint8_t, 3> PreCompiled3dTensorTestImpl(armnn::IWorkloadFactory& workloadFactory,
                                                        const armnn::IBackendInternal::IMemoryManagerSharedPtr&)
{
    // Set up tensor infos
    TensorInfo inputInfo({ 1, 2, 2, 60 }, DataType::QAsymmU8, 1.0f, 0);
