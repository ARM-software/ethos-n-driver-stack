...
{
public:
    DmaRdController(const Command* commandsBegin, uint32_t numCommands, const char* endOfCmdStream);
...
inline DmaRdController::DmaRdController(const Command* commandsBegin, uint32_t numCommands, const char* endOfCmdStream)
