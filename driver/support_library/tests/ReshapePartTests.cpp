...
TEST_CASE("ReshapePart Plan Generation", "[ReshapePartTests]")
{
    GIVEN("A simple ReshapePart")
    {
        ...
        {
            Plans plans = reshapePart.GetPlans(CascadeType::Lonely, BlockConfig{}, { nullptr }, 0);
        ...
        {
            Plans plans = reshapePart.GetPlans(CascadeType::Beginning, BlockConfig{}, { nullptr }, 0);
        ...
        {
            Plans plans = reshapePart.GetPlans(CascadeType::Middle, BlockConfig{}, { nullptr }, 0);
        ...
        {
            Plans plans = reshapePart.GetPlans(CascadeType::End, BlockConfig{}, { nullptr }, 0);
