...
CompilerMceAlgorithm McePart::ResolveMceAlgorithm(const BlockConfig& blockConfig, uint32_t inputStripeChannels) const
{
...
Plans McePart::GetMiddlePlans(BlockConfig blockConfig, const SramBuffer* sramBuffer, uint32_t numWeightStripes) const
{
    assert(sramBuffer);
    Plans ret;
...
Plans McePart::GetEndPlans(BlockConfig blockConfig, const SramBuffer* sramBuffer, uint32_t numWeightStripes) const
{
    assert(sramBuffer);
    Plans ret;
