...
using AgentIdType         = std::vector<command_stream::Agent>::size_type;
...
{
public:
    CommandStreamGenerator(const OpGraph& mergedOpGraph,
                           const EstimatedOpGraph& estimatedOpGraph,
                           const std::set<uint32_t>& operationIds,
                           const HardwareCapabilities& capabilities,
                           const CompilationOptions& compilationOptions,
                           const DebuggingContext& debuggingContext);
    CommandStreamGenerator(const CommandStreamGenerator&) = delete;
    CommandStreamGenerator& operator=(const CommandStreamGenerator&) = delete;
...
private:
    ...
    inline void AddReadAfterWriteDependency(const command_stream::AgentType consumerAgentType,
    ...
    inline void AddWriteAfterReadDependency(const command_stream::AgentType consumerAgentType,
                                            const AgentIdType consumerAgentId,
                                            const command_stream::AgentType producerAgentType,
                                            const AgentIdType producerAgentId,
                                            const Op* producerOp);
