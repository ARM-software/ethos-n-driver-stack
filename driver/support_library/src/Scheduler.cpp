...
Counters Scheduler::CounterImplications::Get(ethosn::command_stream::CounterName counterName, uint32_t value) const
{
...
void Scheduler::CounterImplications::Update(ethosn::command_stream::CounterName counterName,
                                            uint32_t value,
                                            Counters counters)
{
