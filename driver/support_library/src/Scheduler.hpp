...
struct Counters
{
    ...
    uint32_t Get(ethosn::command_stream::CounterName counterName) const;
    void Set(ethosn::command_stream::CounterName counterName, uint32_t value);
...
private:
    ...
    public:
        ...
        Counters Get(ethosn::command_stream::CounterName counterName, uint32_t value) const;

        /// Records that when the given counter reaches the given value, the other counters will have
        /// at least the values given.
        void Update(ethosn::command_stream::CounterName counterName, uint32_t value, Counters counters);
    ...
    private:
        ...
        std::map<std::pair<ethosn::command_stream::CounterName, uint32_t>, Counters> m_Map;
    };
    ...
    CommandQueue& GetQueueForAgentType(command_stream::AgentType agentType);
    void PushWaitForCounterCommand(command_stream::AgentType otherAgentType,
