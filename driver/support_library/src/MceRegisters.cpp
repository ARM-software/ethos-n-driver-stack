...
MceUpsampleType ConvertResizeAlgorithmToMceUpsampleType(ResizeAlgorithm algorithm)
{
...
command_stream::ProgramMceStripeCommand GenerateProgramMceStripeCommand(const MceSDesc& mceS,
                                                                        uint32_t agentId,
                                                                        uint32_t stripeId,
                                                                        const HardwareCapabilities& caps)
{
    ...
    const bool isDepthwise      = mceS.mceOpMode == command_stream::MceOperation::DEPTHWISE_CONVOLUTION;
    const bool isFullyConnected = mceS.mceOpMode == command_stream::MceOperation::FULLY_CONNECTED;
...
command_stream::StartMceStripeCommand GenerateStartMceStripeCommand(const MceSDesc& mceS,
                                                                    uint32_t agentId,
                                                                    uint32_t stripeId,
                                                                    const HardwareCapabilities& caps)
{
...
command_stream::MceS CreateMceS(const MceSDesc& mceSDesc)
{
    MceS mceS        = {};
