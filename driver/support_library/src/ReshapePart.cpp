...
Plans ReshapePart::GetPlans(CascadeType cascadeType, BlockConfig, const std::vector<Buffer*>&, uint32_t) const
{
    Plans plans;
    ...
    if (cascadeType == CascadeType::Lonely)
    {
        ...
        auto dma1            = std::make_unique<DmaOp>(BufferFormat::NHWC);
        ...
        auto dma2             = std::make_unique<DmaOp>(BufferFormat::NHWC);
