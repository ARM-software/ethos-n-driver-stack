...
{
    assert(buffer->m_Format == BufferFormat::NHWCB || buffer->m_Format == BufferFormat::WEIGHT);
...
{
inline void SetBufferDataType(FmSDesc& streamerData, const BufferFormat bufferFormat)
{
    switch (bufferFormat)
    {
