                                  ...
                                  const BlockConfig& blockConfig)
{
    ...
    const uint32_t numBlocksPerOg = ofmsPerOg * utils::DivRoundUp(utils::GetHeight(outputShape), blockConfig.m_Height) *
                                    utils::DivRoundUp(utils::GetWidth(outputShape), blockConfig.m_Width);
                                           ...
                                           const BlockConfig& blockConfig)
{
    ...
    bool isWinogradAllowed = (convtype == command_stream::MceOperation::CONVOLUTION && stride == Stride{ 1, 1 } &&
                              (blockConfig.m_Width * blockConfig.m_Height) <= maxAllowedWxH);
