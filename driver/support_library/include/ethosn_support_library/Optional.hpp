...
public:
    ...
    OptionalReferenceSwitch(ConstructInPlace, Args&&... args)
        : Base{}
    {
        Construct(ConstructInPlace{}, std::forward<Args>(args)...);
    }
...
public:
    ...
    explicit Optional(ConstructInPlace, Args&&... args)
        : BaseSwitch(ConstructInPlace{}, std::forward<Args>(args)...)
    {}
...
{
    return Optional<T>(ConstructInPlace{}, std::forward<Args>(args)...);
}
